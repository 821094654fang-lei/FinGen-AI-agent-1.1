          ...
          >
            <div className="p-6 border-b border-[#141414]/5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-serif italic font-bold">{theme.label} · 优质模版</h2>
                  <p className="text-xs opacity-40 uppercase tracking-widest mt-1">Premium Industry Templates</p>
                </div>
              </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 grid grid-cols-3 gap-6 custom-scrollbar">
              {theme.templates.map((template) => (
                ...
                >
                  <div className="w-full aspect-[3/4] bg-[#E4E3E0] rounded-2xl mb-3 overflow-hidden relative border border-[#141414]/5 group-hover:border-[#141414]/20 transition-all">
                    <img 
                    ...
                    <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <div className="bg-white text-[#141414] px-4 py-2 rounded-full text-xs font-bold flex items-center gap-2 shadow-xl transform translate-y-2 group-hover:translate-y-0 transition-transform">
                        <Sparkles size={14} />
                        使用模版
                      </div>
                    </div>
                  ...
                  <span className="text-[10px] opacity-40 uppercase tracking-widest mt-1">{template.type} · {template.layout}</span>
                </button>
              ))}
            </div>

            <div className="p-6 bg-[#F5F5F0] flex justify-between items-center">
